...
|=======================================================================
| Module      : zdb_top
| Author      : Mythri Muralikannan, Alfi Misha
...
module zdb_top_with_ro #(
    ...
    //ro clock period select
    input wire [1:0]            ro_sel
    ...
    `ifdef RO
        ...
        assign ro_clk_int = ro_clk_int;
    `else
        assign ro_clk_int = ro_clk;
    `endif
    ...
    // -----------------------------------------------------------------
    always @(posedge ro_clk or posedge rst) begin
        if (rst)
